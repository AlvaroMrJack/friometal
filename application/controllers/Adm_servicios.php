...
class Adm_servicios extends CI_Controller {
	...
	{	
		...
		$data["icons"] = $icons;
		$this->load->view('administracion/servicios', $data, FALSE);
	}

}

/* End of file Adm_servicios.php */
/* Location: ./application/controllers/Adm_servicios.php */